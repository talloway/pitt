...
HD_PWD='C:/ece1195/labs/lab3/Lab_3/Lab_3.runs/lab_3_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_3_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_3_processing_system7_0_0.tcl

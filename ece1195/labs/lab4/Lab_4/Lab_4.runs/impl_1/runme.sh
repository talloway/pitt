...
HD_PWD='C:/ece1195/labs/lab4/Lab_4/Lab_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_file.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg_file.tcl -notrace

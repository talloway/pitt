...
HD_PWD='C:/ece1195/labs/lab2/Lab_2/Lab_2.runs/Lab_2_ALU_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_2_ALU_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_2_ALU_0_2.tcl

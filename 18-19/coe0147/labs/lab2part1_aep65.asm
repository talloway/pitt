...
.data
    ...
    machine_code_1:     .asciiz "0x3C08FEDC" 
    machine_code_2:     .asciiz "0x3508BABC"

    #Question 2: What instruction format are these instructions (R, I, or J)?
    #Replace FORMAT with your answer for the instruction format (R, I, J).
    ...
    immediate_field_1:  .asciiz "0xFEDC0000"
    immediate_field_2:  .asciiz "0xFEDCBABC"

.text

    #============================================================
    #Place here your instructions to put 0xFEDCBABC into $t0.
    lui $t0, 65244
    ori $t0, $t0, 47804
    #============================================================

...
class TrainDataset(Dataset):
    def __init__(self, train_list, datadir=None, labeldir=None, feadir=None, args=None, transforms=None, is_train=True):
        graph_dir = join(datadir, args.graphuse)
        label_dir = join(labeldir, args.labeluse)
        fea_dir = join(feadir,args.featureuse)
        names = []
    ...
    def __getitem__(self, index):
        ...
        batch_index = np.repeat(batch_index, num_node)

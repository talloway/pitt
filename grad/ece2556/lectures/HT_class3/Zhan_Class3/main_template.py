...
exp_name = 'HCP'
datadir = 'your datadir'     # where data save
labeldir = 'your labeldir'       # where label save
feadir = 'your feadir'
save_path = join('your save_path', exp_name, datetime.now().strftime('%b%d_%H-%M-%S'))
runs_path = join('your runs_path', exp_name, datetime.now().strftime('%b%d_%H-%M-%S'))
...
def main():
    ...
    parser.add_argument('--graphuse', type=str, default='brain_dti', choices=('brain_dti', 'brain_fmri')) # change here to change adj input
    parser.add_argument('--num_node', type=int, default=246, choices=(246, 50))  # change here to change adj input
    parser.add_argument('--featureuse', type=str, default='fea_10', choices=('brain_dti', 'brain_fmri', 'fea_10'))    # change here to change feature input
    ...
    parser.add_argument('--nEpochs', type=int, default=500)                # change number of training epochs
    parser.add_argument('--change_opt', action='store_true', default=False)
    parser.add_argument('--learning_rate', type=float, default=1e-3)        # change learning rate
    ...
    parser.add_argument('--num_features', type=int, default=10, choices=(246, 10))
...
if __name__ == '__main__':
    main()
    # train_loader= main()
    # for batch_idx, (x,y,z, batch_index) in enumerate(train_loader):
    #     print(x.shape,y.shape,z.shape, batch_index[0].shape)
        # print(batch_idx)
        # print(data.shape)
        # print(target.shape)
        # print(x.shape)

...
add_force {/cpu_tb/U_1/mw_U_0ram_table[1]} -radix hex {20800004}
add_force {/cpu_tb/U_1/mw_U_0ram_table[2]} -radix hex {00640019}
add_force {/cpu_tb/U_1/mw_U_0ram_table[3]} -radix hex {00002810}
add_force {/cpu_tb/U_1/mw_U_0ram_table[4]} -radix hex {00003012}

...
if {[get_value -radix unsigned R] == [expr {0xBA980000}]} {
...
#check if the result is correct
if {[get_value -radix unsigned R] == [expr {0x0000FEDC}]} {
...
#check if the result is correct
if {[get_value -radix unsigned R] == [expr {0xFFFFFEDC}]} {
...
#check if the result is correct
if {[get_value -radix unsigned R] == [expr {0x00000008}]} {
	puts "Correct! AND"
} else {
	puts "Wrong! AND"
}
...
#check if the result is correct
if {[get_value -radix unsigned R] == [expr {0xFFFFFFF8}]} {
	puts "Correct! OR"
} else {
	puts "Wrong! OR"
}
...
#check if the result is correct
if {[get_value -radix unsigned R] == [expr {0xFFFFFFF0}]} {
	puts "Correct! XOR"
} else {
	puts "Wrong! XOR"
}
...
#check if the result is correct
if {[get_value -radix unsigned R] == [expr {0x00000007}]} {
	puts "Correct! NOR"
} else {
	puts "Wrong! NOR"
}

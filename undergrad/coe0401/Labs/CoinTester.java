...
public class CoinTester
{
  ...
  {
    Coin coin1 = new Coin( 17 ); // 17 is the SEED // Constructor should have one argument
    ...
    for (int i=0 ; i<20 ; ++i)
        System.out.print( coin1.flip() + " " ); // Equal chance of head or tail // Flip METHOD
    System.out.println();

    System.out.println("# heads: " + coin1.getNumHeads() +
    		 "  # tails: " + coin1.getNumTails() );                 // getNumHeads/getNumTails methods
    coin1.reset(); // sets numHeads and numTails back to zero; // Reset METHOD

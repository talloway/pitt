...
#
# Bruce Childers
# last modified: 12/01/11, 10:12pm
...
%mnemonic = (ADD  => 0x1001, SUB  => 0x1000, ADDI => 0x0000, ADDUI => 0x0001,
   	     NOR  => 0x2000, AND  => 0x2001, 
             SLLV  => 0x6001, SRLV  => 0x6000, SLL => 0x5001, SRL => 0x5000, 
             LW   => 0x4000, SW   => 0x4001,  
             HALT => 0x7000, 
             BZ   => 0x8000, BX => 0xB000, BP   => 0x9000, BN  => 0xA000, 
             JAL  => 0xC000, JR   => 0xD000, J => 0xE000, PUT  => 0xF000,
	     SET => 0x3000, SETR => 0x3001);
